...
#+BEGIN_SRC perl :tangle bin/foscam-convert-manager.pl :shebang #!/usr/bin/env perl :noweb yes
  ...
  <<get-options-chunk>>
  use File::Basename;
  my $upload_stack_file = "/var/camera/log/cam2.upload";
...
#+BEGIN_SRC perl
  sub foscam_localtime {
      ...
      return($formated_time, $year, $mon, $mday, $hour, $min, $sec);
  }
...
#+BEGIN_SRC perl :tangle lib/foscam-conversion.pm :padline no :noweb ye  sub pop_upload_stack {
    use warnings;
    use strict;
