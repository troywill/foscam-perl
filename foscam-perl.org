* Foscam reference
** Videostream.asf
   #+BEGIN_SRC sh :tangle /tmp/video.sh
     #!/bin/sh
     ...
     RESOLUTION=32
     RATE=14
     vlc http://$HOSTNAME/videostream.asf?user=$USER&pwd=$PASSWORD&resolution=$RESOLUTION&rate=$RATE
   #+END_SRC
#+TBLNAME: videostream.asf
...
* Working programs
** Static images
*** TODO The foscam-snapshot.pl program
**** Usage
#+BEGIN_EXAMPLE
